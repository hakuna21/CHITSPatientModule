...
<openmrs:require privilege="Manage Concepts" otherwise="/login.htm" redirect="/module/chits/admin/drugs/uploadDrugCodes.form" />

<spring:message var="pageTitle" code="chits.admin.drugs.upload.title" scope="page"/>
...
<style>
table.example td { white-space: nowrap; }
</style>

<h2><spring:message code="chits.admin.drugs.upload" /></h2>	
...
<table>
			...
			<span class="guide">
				...
				<br/><br/>e.g.
					<table class="example">
						...
						<tr><td>Drugs</td><td></td><td></td><td></td><td>ConvSet</td><td>N/A</td><td></td><td></td></tr>
						<tr><td>tetanus toxoid</td><td></td><td></td><td>drug; tetanus toxoid</td><td>Drug</td><td>N/A</td><td></td><td>Drugs</td></tr>
						<tr><td>paracetamol</td><td>calpol<br/>acetominophen<br/>panadol<br/>paracetamol syrup</td><td></td><td></td><td>Drug</td><td>N/A</td><td></td><td>Drugs</td></tr>
	...
	<tr>
		<td colspan="2">
			<input type="button" value="Upload Drugs Codes" onclick="return verifyAndConfirm()" />
		</td>
	</tr>
</table>
</form:form>
