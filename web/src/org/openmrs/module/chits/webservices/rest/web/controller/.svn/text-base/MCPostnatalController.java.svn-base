...
import org.openmrs.module.chits.webservices.rest.resource.MCPostnatalEncounterRecordResource;
...
/**
 * Place holder class for supporting the Maternal Care program. Only GET and POST methods are supported to retrieve and update the Maternal Care postpartum
 ...
 */
@Controller
@RequestMapping("/rest/chits/v1/programs/mc/postnatal")
public class MCPostnatalController extends BaseCrudController<MCPostnatalEncounterRecordResource> {
	/**
