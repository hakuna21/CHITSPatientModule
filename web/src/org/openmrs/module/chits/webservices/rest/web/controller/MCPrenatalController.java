...
import org.openmrs.module.chits.webservices.rest.resource.MCPrenatalEncounterRecordResource;
...
/**
 * Place holder class for supporting the Maternal Care program. Only GET and POST methods are supported to retrieve and update the Maternal Care pre-natal
 ...
 */
@Controller
@RequestMapping("/rest/chits/v1/programs/mc/prenatal")
public class MCPrenatalController extends BaseCrudController<MCPrenatalEncounterRecordResource> {
	/**
