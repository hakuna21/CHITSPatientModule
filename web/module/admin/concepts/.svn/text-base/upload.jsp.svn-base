...
<openmrs:require privilege="Manage Concepts" otherwise="/login.htm" redirect="/module/chits/admin/concepts/uploadConcepts.form" />

<spring:message var="pageTitle" code="chits.admin.concepts.upload.title" scope="page"/>
...
<h2><spring:message code="chits.admin.concepts.upload" /></h2>	
...
<table>
	...
	<tr>
		<td colspan="2">
			<input type="button" value="Upload Concepts" onclick="return verifyAndConfirm()" />
		</td>
	</tr>
</table>
</form:form>
