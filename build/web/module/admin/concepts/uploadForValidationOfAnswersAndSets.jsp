...
<openmrs:require privilege="Manage Concepts" otherwise="/login.htm" redirect="/module/chits/admin/concepts/validateAnswersAndSets.form" />

<spring:message var="pageTitle" code="chits.admin.concepts.validate.answers.and.sets.title" scope="page"/>
...
<h2><spring:message code="chits.admin.concepts.validate.answers.and.sets" /></h2>	
...
<table>
	<tr>
		<td>Validate Concept Answers and Sets:</td>
		<td>
	...
	<tr>
		<td colspan="2">
			<input type="button" value="Validate Concept Answers and Sets" onclick="return verifyAndConfirm()" />
		</td>
	</tr>
</table>
</form:form>
