...
/**
 * Views the birth plan chart of the past or present patient maternal care program.
 * 
 * @author Bren
 */
@Controller
@RequestMapping(value = "/module/chits/consults/viewBirthPlanChart.form")
public class ViewBirthPlanChartController {
